...
const ROWS: { label: string; values: string[] }[] = [
  {
    label: "What it is",
    values: [
      "A persistent agent team with its own computers, working across approved tools",
  ...
  },
  {
    ...
    values: [
      "A person, routine, or connected signal",
      "You assign a task",
  ...
  },
  {
    label: "What you get",
    values: [
      "A reviewable artifact with its work context",
  ...
  return (
    <section id="compare" className="compare">
      ...
      <p className="section-lede">
        Grok Bot gives each agent a persistent computer and a chat surface for
        review.
      </p>
